...
WebUI.verifyElementText(findTestObject('Object Repository/Settings/Repair_Impact_Editor_UI/Page_Streetlogix/text_0,40'), pciBoundaries[0].toString().replace("[", '').replace("]",'').replace(" ", ''))

WebUI.verifyElementText(findTestObject('Object Repository/Settings/Repair_Impact_Editor_UI/Page_Streetlogix/div_bar1'), impactValues[0])

WebUI.verifyElementText(findTestObject('Object Repository/Settings/Repair_Impact_Editor_UI/Page_Streetlogix/text_40,70'), pciBoundaries[1].toString().replace("[", '').replace("]",'').replace(" ", ''))

WebUI.verifyElementText(findTestObject('Object Repository/Settings/Repair_Impact_Editor_UI/Page_Streetlogix/div_bar2'), impactValues[1])

WebUI.verifyElementText(findTestObject('Object Repository/Settings/Repair_Impact_Editor_UI/Page_Streetlogix/text_70,90'), pciBoundaries[2].toString().replace("[", '').replace("]",'').replace(" ", ''))

WebUI.verifyElementText(findTestObject('Object Repository/Settings/Repair_Impact_Editor_UI/Page_Streetlogix/div_bar3'), impactValues[2])

WebUI.verifyElementText(findTestObject('Object Repository/Settings/Repair_Impact_Editor_UI/Page_Streetlogix/text_90,100'), pciBoundaries[3].toString().replace("[", '').replace("]",'').replace(" ", ''))

WebUI.verifyElementText(findTestObject('Object Repository/Settings/Repair_Impact_Editor_UI/Page_Streetlogix/div_bar4'), impactValues[3])
