...
WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_Sidewalk Condition Index'))
...
WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_SCI_Historic'))

WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/div_Select Filter2'))

WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_is'))

WebUI.setText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/input__input2'), '71')
...
WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-sorter_sci_objectid'), 'OBJECTID')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-sorter_sci_SCI_Historic'), 'SCI_historic')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-cell-content_sci_1'), '4')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-cell-content_sci_80'), '71')

WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/div_Esri_sc-gKAaRy bVZRMQ'))

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/h3_Sidewalk Evaluation'), 'Sidewalk Evaluation')
