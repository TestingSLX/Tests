...
println(updatedRepairImpactAutoUpdate1[2])
...
if (updatedRepairImpactAutoUpdate1 == []) {
    ...
    println(updatedRepairImpactAutoUpdate1[0])
...
String newPCI3 = WebUI.getAttribute(findTestObject('Object Repository/Settings/Repair_Impact_Editor_Validation/Page_Streetlogix/input_Auto-update_pci'), 
    'value')
...
String newMaintenanceSuggestion3 = WebUI.getAttribute(findTestObject('Object Repository/Settings/Repair_Impact_Editor_Validation/Page_Streetlogix/input__Maintenance_Suggestion'), 
    'value')

def updatedRepairImpactAutoUpdate3 = CustomKeywords.'com.database_keywords.test.Database_Keywords.repairImpactAttributeEditorValidation'(
    newPCI3.toInteger())
...
String newEstimatedCost3 = WebUI.getAttribute(findTestObject('Object Repository/Settings/Repair_Impact_Editor_Validation/Page_Streetlogix/input__estimated_cost'), 
    'value')
...
String newPCI4 = WebUI.getAttribute(findTestObject('Object Repository/Settings/Repair_Impact_Editor_Validation/Page_Streetlogix/input_Auto-update_pci'), 
    'value')
...
String newMaintenanceSuggestion4 = WebUI.getAttribute(findTestObject('Object Repository/Settings/Repair_Impact_Editor_Validation/Page_Streetlogix/input__Maintenance_Suggestion'), 
    'value')

def updatedRepairImpactAutoUpdate4 = CustomKeywords.'com.database_keywords.test.Database_Keywords.repairImpactAttributeEditorValidation'(
    newPCI4.toInteger())
...
String newEstimatedCost4 = WebUI.getAttribute(findTestObject('Object Repository/Settings/Repair_Impact_Editor_Validation/Page_Streetlogix/input__estimated_cost'), 
    'value')
