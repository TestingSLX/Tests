...
WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_PavementMarkings Lines'))
...
WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_Line Color'))

WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/div_Select Filter2'))

WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_is'))

WebUI.setText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/input__input2'), 'Yellow')
...
WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-sorter_objectid_pavementmarkingslines'), 'objectid')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-sorter_Line Color'), 'Line Color')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-cell-content_3_pavementmarkingslines'), '3')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-cell-content_Yellow'), 'Yellow')

WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/div_Esri_sc-gKAaRy bVZRMQ'))

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/h3_Sidewalk Evaluation'), 'Other Assets')
