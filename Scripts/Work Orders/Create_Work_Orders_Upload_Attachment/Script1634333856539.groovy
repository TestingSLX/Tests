...
//
CustomKeywords.'com.database_keywords.test.Database_Keywords.uploadFile'(findTestObject('Object Repository/Work_Orders/Create_Work_Orders/Page_Streetlogix/div_Upload'), 'PDF.pdf')
//
...
def status = CustomKeywords.'com.database_keywords.test.Database_Keywords.verifyDocumentUploaded'()
