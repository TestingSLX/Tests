...
WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_Sign Types'))
...
WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_signcategory'))

WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/div_Select Filter2'))

WebUI.click(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/li_is'))

WebUI.setText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/input__input2'), 'Regulatory')
...
WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-sorter_objectid_signtype'), 'objectid')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-sorter_signcategory'), 'signcategory')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-cell-content_signtype'), '3')

WebUI.verifyElementText(findTestObject('Filter/Add_Set_Pavement_Distress/Page_Streetlogix/vaadin-grid-cell-content_Regulatory'), 'Regulatory')
