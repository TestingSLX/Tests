...
List<WebElement> list = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/Work_Orders/Verify_forms_in_group/Allgroups/Page_Streetlogix/ul_forms'), 
    30)
...
List<WebElement> groups = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/Work_Orders/Verify_forms_in_group/Page_Streetlogix/ul_GroupsDropdown'), 30)
...
for(group in groups) {
	if(group.getProperties()["text"].equals("Operations")) {
		group.click()
		List<WebElement> list2 = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/Work_Orders/Verify_forms_in_group/Allgroups/Page_Streetlogix/ul_forms'),
		    30)
...
List<WebElement> groups1 = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/Work_Orders/Verify_forms_in_group/Page_Streetlogix/ul_GroupsDropdown'), 30)
...
for(group1 in groups1) {
	...
	if(group1.getProperties()["text"].equals("Roads and Highways")) {
		group1.click()
		List<WebElement> list3 = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/Work_Orders/Verify_forms_in_group/Allgroups/Page_Streetlogix/ul_forms'),
			30)
...
List<WebElement> groups2 = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/Work_Orders/Verify_forms_in_group/Page_Streetlogix/ul_GroupsDropdown'), 30)
